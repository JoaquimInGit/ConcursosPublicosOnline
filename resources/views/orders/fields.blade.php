...
@else
    <div class="row">
        <div class="form-group col-md-6">
            ...
            {!! Form::select('entity_id',\App\Models\Entity::all()->pluck('name','id')->toArray(), null, ['class' => 'form-control '.($errors->has('entity_id') ? 'is-invalid' : ''),'placeholder' => __('Select a Entity')]) !!}
            @error('entity_id')
        ...
        <div class="form-group col-md-6">
            ...
            {!! Form::select('user_id',\App\Models\User::all()->pluck('name','id')->toArray(), null, ['class' => 'form-control '.($errors->has('user_id') ? 'is-invalid' : ''),'placeholder' => __('Select a User')]) !!}
            @error('user_id')
                <div class="error invalid-feedback">{{ $message }}</div>
            @enderror
        </div>
