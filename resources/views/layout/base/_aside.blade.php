...
<div class="aside aside-left {{ Metronic::printClasses('aside', false) }} d-flex flex-column flex-row-auto" id="kt_aside">
    ...
    <div class="brand flex-column-auto {{ Metronic::printClasses('brand', false) }}" id="kt_brand">
        <div class="brand-logo">
            <a href="{{ url('/') }}">
                <img alt="{{ config('app.name') }}" src="{{ asset('media/logos/logo-concursos-online.jpeg') }}" width="150px"/>
            </a>
        </div>
    ...
    <div class="aside-menu-wrapper flex-column-fluid" id="kt_aside_menu_wrapper">
        ...
        <div
            ...
            <ul class="menu-nav {{ Metronic::printClasses('aside_menu_nav', false) }}">
                ...
                @can('manageApp')
                    <li class="menu-item {{ request()->routeIs('contests.*') ? "menu-item-active" : "" }}" aria-haspopup="true">
                        <a href="{{ route('contests.index') }}" class="menu-link">
                            <span class="svg-icon menu-icon">
                            ...
                            <span class="menu-text">{{ __('Contests') }}</span>
                        </a>
                    </li>
                    <li class="menu-item {{ request()->routeIs('products.*') ? "menu-item-active" : "" }}" aria-haspopup="true">
                ...
                @endcan
                <li class="menu-section">
                    <h4 class="menu-text">{{ __('Configurations') }}</h4>
                    <i class="menu-icon ki ki-bold-more-hor icon-md"></i>
                </li>
                @can('adminFullApp')
                    <li class="menu-item menu-item-submenu {{ request()->routeIs('roles.*') ? "menu-item-open" : "" }}" aria-haspopup="true" data-menu-toggle="hover">
                ...
                @can('adminFullApp')
                    <li class="menu-item menu-item-submenu {{ request()->routeIs('settings.*') ? "kt-menu__item--open" : "" }}" aria-haspopup="true" data-menu-toggle="hover">
                        ...
                        <div class="menu-submenu">
                            ...
                            <ul class="menu-subnav">
                                ...
                                <li class="menu-item {{ request()->routeIs('settings.index') ? "menu-item-active" : "" }}" aria-haspopup="true">
                                    <a href="{{ route('settings.index') }}" class="menu-link">
                                        <i class="menu-bullet menu-bullet-dot"> <span></span></i>
                                        <span class="menu-text">{{ __('List settings') }}</span>
                                    </a>
                                </li>
                                <li class="menu-item {{ request()->routeIs('settings.create') ? "menu-item-active" : "" }}" aria-haspopup="true">
                                    <a href="{{ route('settings.create') }}" class="menu-link">
                                        <i class="menu-bullet menu-bullet-dot"><span></span></i>
                                        <span class="menu-text">{{ __('Create setting') }}</span>
                                    </a>
                                </li>
                            </ul>
                        </div>
                    </li>
                    <li class="menu-item {{ request()->routeIs('translations.*') ? "menu-item-active" : "" }}" aria-haspopup="true">
                        <a href="/translations" class="menu-link">
                            <span class="svg-icon menu-icon"><!--begin::Svg Icon | path:/var/www/preview.keenthemes.com/metronic/releases/2020-07-07-181510/theme/html/demo1/dist/../src/media/svg/icons/Home/Globe.svg--><svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
