(function ($, DataTable) {
    ...
    DataTable.ext.buttons.excel = {
        ...
        text: function (dt) {
            return '<i class="kt-nav__link-icon la la-file-excel-o"></i> ' + dt.i18n('buttons.excel', 'Excel');
        },
    ...
    DataTable.ext.buttons.export = {
        ...
        text: function (dt) {
            return '<i class="la la-download"></i> ' + dt.i18n('buttons.export', 'Export') + '&nbsp;<span class="caret"/>';
        },
    ...
    DataTable.ext.buttons.csv = {
        ...
        text: function (dt) {
            return '<i class="kt-nav__link-icon la la-file-text-o"></i> ' + dt.i18n('buttons.csv', 'CSV');
        },
    ...
    DataTable.ext.buttons.postCsvVisibleColumns = {
        ...
        text: function (dt) {
            return '<i class="kt-nav__link-icon la la-file-text-o"></i> ' + dt.i18n('buttons.csv', 'CSV (only visible columns)');
        },
    ...
    DataTable.ext.buttons.pdf = {
        ...
        text: function (dt) {
            return '<i class="kt-nav__link-icon la la-file-pdf-o"></i> ' + dt.i18n('buttons.pdf', 'PDF');
        },
    ...
    DataTable.ext.buttons.print = {
        ...
        text: function (dt) {
            return  '<i class="kt-nav__link-icon la la-print"></i> ' + dt.i18n('buttons.print', 'Print');
        },
